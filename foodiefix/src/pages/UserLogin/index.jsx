...
const UserLogin = () => {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-wrap md:flex-nowrap bg-white shadow-lg rounded-lg overflow-hidden w-3/4 md:w-1/2 h-3/4 md:h-auto">
        <div className="w-full md:w-1/2 p-8">
          ...
          <form>
            ...
            <p className="text-sm">Don't have an account? <a href="#" className="text-green-500 hover:text-green-800">Sign Up</a></p>
          </form>
        </div>
        <div className="w-full md:w-1/2 bg-cover" style={{ backgroundImage: `url(${sideimage})` }}></div>
      </div>
    </div>
  )
}
